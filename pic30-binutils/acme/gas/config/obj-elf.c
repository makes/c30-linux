...
#if defined(TC_PIC30)
static int obj_elf_parse_section_letters PARAMS ((char *, size_t, int *));
#else
...
static int
#if defined(TC_PIC30)
obj_elf_parse_section_letters (char *str, size_t len, int *type)
#else
...
#if defined(TC_PIC30)
	  attr |= obj_elf_parse_section_letters (beg, strlen (beg), &type);
#else
